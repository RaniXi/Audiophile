...
//    // EVENT EMITTER
//    [SerializedField]
//    public StudioEventEmitter tavernEmitter; // Declaration of a public field that holds the reference to the event emitter on the scene.
//    #endregion

//    #region EVENT
//    // EVENT
//    FMOD.Studio.EventInstance FootstepsSound; // Declaration of a variable that will store the instance of the Footsteps event.
//    public EventReference footstepsEventRef; // or event:/music // Declaration of a public field that holds the reference to the file with the Footsteps event.

//    private void Footsteps()
//    {
//        // one-time playback
//        FMODUnity.RuntimeManager.PlayOneShot(footstepsEventRef); // Plays the event once without managing its instance.

//        // basic event management
//        FootstepsSound = FMODUnity.RuntimeManager.CreateInstance(footstepsEventRef); // Creates a new instance of the Footsteps event.
...
//        FootstepsSound = FMODUnity.RuntimeManager.CreateInstance(footstepsEventRef);
